...
GHOST_TSuccess GHOST_Window::setDrawingContextType(
...
GHOST_TSuccess GHOST_Window::getCursorGrabBounds(GHOST_Rect &bounds) const
{
	...
	return (bounds.m_l == -1 && bounds.m_r == -1) ? GHOST_kFailure :
													GHOST_kSuccess;
}
									  ...
									  bool &use_software_cursor)
{
	...
	use_software_cursor = (m_cursorGrab != GHOST_kGrabDisable) ?
