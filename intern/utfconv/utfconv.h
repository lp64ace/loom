...
/**
 * Counts how many wchar_t (two byte) is required for future utf-16 string using
 * utf-8 \param string8: pointer to working utf-8 string \return How many bytes
 * must be allocated including NULL.
 */
...
/** Passed size is to small. It gives legal string with character missing at the
 * end. */
 ...
 * \param in16: utf-16 string to convert
 * \param add: any additional size which will be allocated for new utf-8 string
 * in bytes \return New allocated and converted utf-8 string or NULL if in16 is
 * 0.
 */
...
/* Easy allocation and conversion of new utf-16 string. New string has _16
 * suffix. Must be deallocated with UTF16_UN_ENCODE in right order. */
