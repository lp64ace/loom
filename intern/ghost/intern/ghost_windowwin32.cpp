...
extern "C" {
	__declspec( dllexport ) DWORD NvOptimusEnablement = 0x00000001;
        ...
        typedef BOOL ( WINAPI *GHOST_WIN32_AdjustWindowRectExForDpi )( LPRECT lpRect , DWORD dwStyle , BOOL bMenu , DWORD dwExStyle , UINT dpi );
}
...
HCURSOR GHOST_WindowWin32::getStandardCursor ( GHOST_TStandardCursor shape ) const {
        ...
        switch ( shape ) {
                ...
                cursor = ::LoadImage ( module , _T ( "arrowright_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                case GHOST_kStandardCursorLeftArrow:
                cursor = ::LoadImage ( module , _T ( "arrowleft_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                case GHOST_kStandardCursorUpArrow:
                cursor = ::LoadImage ( module , _T ( "arrowup_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                case GHOST_kStandardCursorDownArrow:
                cursor = ::LoadImage ( module , _T ( "arrowdown_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                case GHOST_kStandardCursorVerticalSplit:
                cursor = ::LoadImage ( module , _T ( "splitv_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                case GHOST_kStandardCursorHorizontalSplit:
                cursor = ::LoadImage ( module , _T ( "splith_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                case GHOST_kStandardCursorKnife:
                cursor = ::LoadImage ( module , _T ( "knife_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                case GHOST_kStandardCursorEyedropper:
                cursor = ::LoadImage ( module , _T ( "eyedropper_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                case GHOST_kStandardCursorZoomIn:
                cursor = ::LoadImage ( module , _T ( "zoomin_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                case GHOST_kStandardCursorZoomOut:
                cursor = ::LoadImage ( module , _T ( "zoomout_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                case GHOST_kStandardCursorMove:
                cursor = ::LoadImage ( module , _T ( "handopen_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                case GHOST_kStandardCursorNSEWScroll:
                cursor = ::LoadImage ( module , _T ( "scrollnsew_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                case GHOST_kStandardCursorNSScroll:
                cursor = ::LoadImage ( module , _T ( "scrollns_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                case GHOST_kStandardCursorEWScroll:
                cursor = ::LoadImage ( module , _T ( "scrollew_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                ...
                cursor = ::LoadImage ( module , _T ( "cross_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break; /* Standard Cross */
                case GHOST_kStandardCursorCrosshairA:
                cursor = ::LoadImage ( module , _T ( "crossA_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break; /* Crosshair A */
                case GHOST_kStandardCursorCrosshairB:
                cursor = ::LoadImage ( module , _T ( "crossB_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break; /* Diagonal Crosshair B */
                case GHOST_kStandardCursorCrosshairC:
                cursor = ::LoadImage ( module , _T ( "crossC_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break; /* Minimal Crosshair C */
                case GHOST_kStandardCursorBottomSide:
                case GHOST_kStandardCursorUpDown:
                cursor = ::LoadImage ( module , _T ( "movens_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break; /* Double-pointed arrow pointing north and south */
                case GHOST_kStandardCursorLeftSide:
                case GHOST_kStandardCursorLeftRight:
                cursor = ::LoadImage ( module , _T ( "moveew_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                ...
                cursor = ::LoadImage ( module , _T ( "pencil_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                case GHOST_kStandardCursorEraser:
                cursor = ::LoadImage ( module , _T ( "eraser_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
                break;
                case GHOST_kStandardCursorDestroy:
                case GHOST_kStandardCursorStop:
                cursor = ::LoadImage ( module , _T ( "forbidden_cursor" ) , IMAGE_CURSOR , cx , cy , flags );
