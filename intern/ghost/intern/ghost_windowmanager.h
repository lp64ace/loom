...
class GHOST_WindowManager {
   public:
	 ...
	 * There can be only one window active which should be in the current window
	 * list. \param window: The new active window.
	 */
	 ...
	 * There can be only one window active which should be in the current window
	 * list. \return window The active window (or NULL if there is none).
	 */
   ...
   protected:
	...
	/** Window in full-screen state. There can be only one of this which is not
	 * in or window list. */
