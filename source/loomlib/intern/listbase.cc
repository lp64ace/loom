...
void *GLU_rfindstring ( const ListBase *listbase , const char *id , const int offset ) {
...
void *GLU_findstring_ptr ( const ListBase *listbase , const char *id , const int offset ) {
	Link *link = nullptr;
	const char *id_iter;
...
void *GLU_rfindstring_ptr ( const ListBase *listbase , const char *id , const int offset ) {
...
int GLU_findstringindex ( const ListBase *listbase , const char *id , const int offset ) {
	Link *link = nullptr;
	const char *id_iter;
	int i = 0;
