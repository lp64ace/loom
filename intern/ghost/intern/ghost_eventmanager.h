...
class GHOST_EventManager {
   public:
	 ...
	 * If non-null, the routine will remove events only associated with that
	 * window. \param type: The type of events to be removed. \param window: The
	 * window to remove the events for.
	 */
