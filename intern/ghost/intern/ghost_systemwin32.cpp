...
#else
	MessageBoxW ( HWND_DESKTOP , message_16 , title_16 , ( dialog_options & GHOST_DialogError ? MB_ICONERROR : dialog_options & GHOST_DialogWarning ? MB_ICONWARNING : MB_ICONINFORMATION ) | MB_OK );
#endif
