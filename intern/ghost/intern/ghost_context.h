...
class GHOST_Context : public GHOST_IContext {
   public:
	 ...
	 * delete the object. \return Indication as to whether initialization has
	 * succeeded.
	 */
	 ...
	 * read. \return Whether the swap interval can be read.
	 */
	 ...
	 * \return  A boolean success indicator.
	 */
	virtual GHOST_TSuccess getVulkanHandles(
		void * /*r_instance*/,
...
#	endif
#	define WIN32_CHK_SILENT(x, silent) \
		((silent) ? win32_silent_chk(x) : WIN32_CHK(x))
#endif /* _WIN32 */
