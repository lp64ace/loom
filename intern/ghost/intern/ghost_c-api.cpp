...
void GHOST_ShowMessageBox ( GHOST_HSYSTEM systemhandle , const char *title , const char *message , const char *help , const char *cont , const char *link , GHOST_DialogOptions options ) {
	GHOST_ISystem *system = ( GHOST_ISystem * ) systemhandle;
	system->showMessageBox ( title , message , help , cont , link , options );
}

GHOST_HEVTCONSUMER GHOST_CreateEventConsumer ( GHOST_EventCallbackProcPtr eventcallback , void *userdata ) {
	GHOST_CallbackEventConsumer *consumer = new GHOST_CallbackEventConsumer ( eventcallback , userdata );
...
GHOST_HTTASK GHOST_InstallTimer ( GHOST_HSYSTEM systemhandle ,
	...
	GHOST_ISystem *system = ( GHOST_ISystem * ) systemhandle;
	return ( GHOST_HTTASK ) system->installTimer ( delay , interval , timerproc , userdata );
}
...
void GHOST_GetMainDisplayDimensions ( GHOST_HSYSTEM systemhandle , uint32_t *width , uint32_t *height ) {
	GHOST_ISystem *system = ( GHOST_ISystem * ) systemhandle;
	system->getMainDisplayDimensions ( *width , *height );
}

void GHOST_GetAllDisplayDimensions ( GHOST_HSYSTEM systemhandle , uint32_t *width , uint32_t *height ) {
	GHOST_ISystem *system = ( GHOST_ISystem * ) systemhandle;
...
GHOST_HWND GHOST_CreateWindow ( GHOST_HSYSTEM systemhandle ,
	...
	return ( GHOST_HWND ) system->createWindow ( title ,
						     left ,
						     top ,
						     width ,
						     height ,
...
void GHOST_SetWindowUserData ( GHOST_HWND windowhandle , GHOST_TUserDataPtr userdata ) {
	GHOST_IWindow *window = ( GHOST_IWindow * ) windowhandle;
...
void GHOST_SetTimerProc ( GHOST_HTTASK timertaskhandle , GHOST_TimerProcPtr timerproc ) {
	GHOST_ITimerTask *timertask = ( GHOST_ITimerTask * ) timertaskhandle;
...
void GHOST_SetTimerTaskUserData ( GHOST_HTTASK timertaskhandle , GHOST_TUserDataPtr userdata ) {
	GHOST_ITimerTask *timertask = ( GHOST_ITimerTask * ) timertaskhandle;
...
GHOST_TSuccess GHOST_SetWindowState ( GHOST_HWND windowhandle , GHOST_TWindowState state ) {
	GHOST_IWindow *window = ( GHOST_IWindow * ) windowhandle;

	return window->setState ( state );
}

GHOST_TSuccess GHOST_SetWindowModifiedState ( GHOST_HWND windowhandle , bool isUnsavedChanges ) {
	GHOST_IWindow *window = ( GHOST_IWindow * ) windowhandle;

	return window->setModifiedState ( isUnsavedChanges );
}

GHOST_TSuccess GHOST_SetWindowOrder ( GHOST_HWND windowhandle , GHOST_TWindowOrder order ) {
	GHOST_IWindow *window = ( GHOST_IWindow * ) windowhandle;
...
unsigned int GHOST_GetContextDefaultOpenGLFramebuffer ( GHOST_HCONTEXT contexthandle ) {
	GHOST_IContext *context = ( GHOST_IContext * ) contexthandle;
...
void GHOST_UnionPointRectangle ( GHOST_HRECT rectanglehandle , int32_t x , int32_t y ) {
	( ( GHOST_Rect * ) rectanglehandle )->unionPoint ( x , y );
}

GHOST_TSuccess GHOST_IsInsideRectangle ( GHOST_HRECT rectanglehandle , int32_t x , int32_t y ) {
	GHOST_TSuccess result = GHOST_kFailure;
...
GHOST_TVisibility GHOST_GetRectangleVisibility ( GHOST_HRECT rectanglehandle ,
						 GHOST_HRECT anotherrectanglehandle ) {
...
void GHOST_SetCenterRectangle ( GHOST_HRECT rectanglehandle , int32_t cx , int32_t cy ) {
	( ( GHOST_Rect * ) rectanglehandle )->setCenter ( cx , cy );
}

void GHOST_SetRectangleCenter ( GHOST_HRECT rectanglehandle , int32_t cx , int32_t cy , int32_t w , int32_t h ) {
