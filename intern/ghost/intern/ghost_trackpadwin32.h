...
class GHOST_DirectManipulationHelper {
   public:
	 ...
	 * \return Pointer to the new GHOST_DirectManipulationHelper if created,
	 ...
	 * DirectManipulation's intended use is to tie user input into
	 * DirectComposition's compositor scaling and translating. We are not using
	 * DirectComposition and therefore must drive DirectManipulation manually.
	 */
	void update();
   ...
   private:
	...
	Microsoft::WRL::ComPtr<IDirectManipulationManager>
		m_directManipulationManager;
	Microsoft::WRL::ComPtr<IDirectManipulationUpdateManager>
		m_directManipulationUpdateManager;
	Microsoft::WRL::ComPtr<IDirectManipulationViewport>
		m_directManipulationViewport;
	Microsoft::WRL::ComPtr<GHOST_DirectManipulationViewportEventHandler>
