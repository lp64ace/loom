...
class GHOST_Window : public GHOST_IWindow {
   public:
	 ...
	 * virtual  GHOST_TSuccess setClientSize(uint32_t width, uint32_t height) =
	 * 0; virtual void screenToClient( int32_t inX, int32_t inY, int32_t& outX,
	 * int32_t& outY) const = 0; virtual void clientToScreen( int32_t inX,
	 * int32_t inY, int32_t& outX, int32_t& outY) const = 0; virtual
	 * GHOST_TWindowState getState() const = 0; virtual GHOST_TSuccess
	 * setState(GHOST_TWindowState state) = 0; virtual GHOST_TSuccess
	 * setOrder(GHOST_TWindowOrder order) = 0; virtual GHOST_TSuccess
	 * swapBuffers() = 0; virtual GHOST_TSuccess setSwapInterval() = 0; virtual
	 * GHOST_TSuccess getSwapInterval(int& intervalOut) = 0; virtual
	 * GHOST_TSuccess activateDrawingContext() = 0; virtual GHOST_TSuccess
	 * invalidate() = 0;
	 */
	 ...
	 */
	GHOST_TSuccess setDrawingContextType(
		GHOST_TDrawingContextType type) override;
   ...
   protected:
	 ...
	 * \return Indication as to whether installation has succeeded.
	 */
	virtual GHOST_Context *newDrawingContext(
		GHOST_TDrawingContextType type) = 0;
	 ...
	 * native window system calls.
	 */
	virtual GHOST_TSuccess setWindowCursorShape(
		GHOST_TStandardCursor shape) = 0;
