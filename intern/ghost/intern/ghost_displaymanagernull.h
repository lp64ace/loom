...
class GHOST_DisplayManagerNULL : public GHOST_DisplayManager {
   public:
	...
	GHOST_TSuccess getNumDisplaySettings(
		uint8_t /*display*/, int32_t & /*numSettings*/) const override
	{
		return GHOST_kFailure;
	}
	...
	GHOST_TSuccess getCurrentDisplaySetting(
		uint8_t display, GHOST_DisplaySetting &setting) const override
	{
		return getDisplaySetting(display, int32_t(0), setting);
	}
	GHOST_TSuccess setCurrentDisplaySetting(
		uint8_t /*display*/, const GHOST_DisplaySetting & /*setting*/) override
	{
