...
void _LOOM_assert_print_pos ( const char *file , int line , const char *function , const char *id );
void _LOOM_assert_print_extra ( const char *str );
void _LOOM_assert_print_backtrace ( void );
void _LOOM_assert_abort ( void );
void _LOOM_assert_unreachable_print ( const char *file , int line , const char *function );
...
#  if defined(__GNUC__)
#    define _LOOM_ASSERT_PRINT_POS(a) _LOOM_assert_print_pos(__FILE__, __LINE__, __func__, #    a)
#  elif defined(_MSC_VER)
#    define _LOOM_ASSERT_PRINT_POS(a) _LOOM_assert_print_pos(__FILE__, __LINE__, __func__, #    a)
#  else
#    define _LOOM_ASSERT_PRINT_POS(a) _LOOM_assert_print_pos(__FILE__, __LINE__, "<?>", #    a)
#  endif
...
#  define LOOM_STATIC_ASSERT(a,msg) ((void)0) /* Workaround error with COVERITY */
...
#define LOOM_STATIC_ASSERT_ALIGN(st, align) LOOM_STATIC_ASSERT((sizeof(st) % (align) == 0), "Structure must be strictly aligned")
