 ...
 *   is the area that is drawable by the application (excluding title bars
 * etc.).
 */
class GHOST_IWindow {
   public:
	 ...
	 */
	virtual GHOST_TSuccess setDrawingContextType(
	 ...
	 * \return Indication of success.
	 */
	virtual GHOST_TSuccess setCursorShape(
		GHOST_TStandardCursor cursorShape) = 0;
	 ...
	 * \return Indication of success.
	 */
	virtual GHOST_TSuccess hasCursorShape(
		GHOST_TStandardCursor cursorShape) = 0;
