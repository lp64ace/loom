...
class GHOST_DisplayManager {
   public:
	 ...
	 * getNumDisplays(). \param numSettings: The number of settings of the
	 * display device with this index. \return Indication of success.
	 */
	 ...
	 * \param display: The index of the display to query with 0 <= display <
	 * getNumDisplays(). \param index: The setting index to be returned. \param
	 * setting: The setting of the display device with this index. \return
	 * Indication of success.
	 */
	virtual GHOST_TSuccess getDisplaySetting(
		uint8_t display, int32_t index, GHOST_DisplaySetting &setting) const;

	/**
	 * Returns the current setting for this display device.
	 * \param display: The index of the display to query with 0 <= display <
	 * getNumDisplays(). \param setting: The current setting of the display
	 * device with this index. \return Indication of success.
	 */
	virtual GHOST_TSuccess getCurrentDisplaySetting(
		uint8_t display, GHOST_DisplaySetting &setting) const;

	/**
	 * Changes the current setting for this display device.
	 * The setting given to this method is matched against the available display
	 * settings. The best match is activated (@see findMatch()). \param display:
	 * The index of the display to query with 0 <= display < getNumDisplays().
	 * \param setting: The setting of the display device to be matched and
	 * activated. \return Indication of success.
	 */
	virtual GHOST_TSuccess setCurrentDisplaySetting(
