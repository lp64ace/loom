...
class GHOST_WindowNULL : public GHOST_Window {
   public:
	GHOST_TSuccess hasCursorShape(
		GHOST_TStandardCursor /*cursorShape*/) override
	{
   ...
   protected:
	...
	GHOST_TSuccess setWindowCursorShape(
		GHOST_TStandardCursor /*shape*/) override
	{
		return GHOST_kSuccess;
	}
	...
	GHOST_TSuccess setClientSize(uint32_t /*width*/,
   ...
   private:
	 ...
	 */
	GHOST_Context *newDrawingContext(
